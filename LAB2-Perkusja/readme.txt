Przykładowe dźwięki: dźwięki z 99sounds.org 
...
Jak uruchomić:
PPM src folder -> Open in Integrated Terminal -> tsc --watch -outDir ../build index.ts -> PPM index.html -> Open with Live Server
